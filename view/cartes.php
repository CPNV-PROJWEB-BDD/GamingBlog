...
?>
    ...
    <meta charset="UTF-8">
    <link rel="stylesheet" href="view/content/assets/css/cartes.css">
    <body>
    <h1>Les Cartes Valorant</h1>
    <ul>
        <li>
            <h2>Bind</h2>
            <img src="view/content/images/Bind.png" alt="Image de la carte Bind">
        ...
        <li>
            <h2>Haven</h2>
            <img src="view/content/images/Haven.png" alt="Image de la carte Haven">
        ...
        <li>
            <h2>Split</h2>
            <img src="view/content/images/Split.png" alt="Image de la carte Split">
        ...
        <li>
            <h2>Ascent</h2>
            <img src="view/content/images/Ascent.png" alt="Image de la carte Ascent">
        ...
        <li>
            <h2>Icebox</h2>
            <img src="view/content/images/Icebox.png" alt="Image de la carte Icebox">
        ...
        <li>
            <h2>Breeze</h2>
            <img src="view/content/images/Breeze.png" alt="Image de la carte Breeze">
        ...
        <li>
            <h2>Pearl</h2>
            <img src="view/content/images/Pearl.png" alt="Image de la carte Pearl">
        ...
        <li>
            <h2>Lotus</h2>
            <img src="view/content/images/Lotus.png" alt="Image de la carte Lotus">
        ...
        <li>
            <h2>Fracture</h2>
            <img src="view/content/images/Fracture.png" alt="Image de la carte Fracture">
        ...
        <li>
            <h2>The Range</h2>
            <img src="view/content/images/The_Range.png" alt="Image de la carte The Range">
